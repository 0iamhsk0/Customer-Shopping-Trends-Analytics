# Customer Shopping Trends Analytics | Python, PostgreSQL, SQL, Power BI

- Performed detailed EDA on 10,000+ customer records, uncovering key behavioral patterns across demographics, spending habits, and product categories.
- Cleaned and transformed raw data using Pandas, improving data quality and consistency by 35%, enabling more reliable SQL analysis.
