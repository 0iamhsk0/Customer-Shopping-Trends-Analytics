...
A complete end-to-end data analytics project covering **Python EDA**, **data cleaning**, **SQL-based insights**, and a **Power BI dashboard** to uncover behavioral shopping patterns across demographics, subscriptions, shipping preferences, and product categories.
...
6️⃣ Generate report & presentation for stakeholders  
